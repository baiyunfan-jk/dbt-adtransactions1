...
left join {{ref('glaucus_p_gl_account_decision_conf_sync_pda')}} as stgy on front.win_config_id =  stgy.config_id and front.req_bucket =  stgy.bucket --and front.p_day =  stgy.input_pday
