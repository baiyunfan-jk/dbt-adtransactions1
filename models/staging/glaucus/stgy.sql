...
with stgy as ( -- 策略中文名 排老黑2.0/PreA4.0低分高分差异化出价
    select
        config_id,
        bucket,
        input_date,
...
(
    ...
    from fin_dm_data_ai.prd_glaucus_p_gl_account_decision_conf_sync_pda LATERAL VIEW EXPLODE(split(bucketIds, ",")) as bucket
